...
- Report a bug or request a new feature in our [issue tracker](https://github.com/DataONEorg/d1_libclient_java/issues)
...
- add an [issue](https://github.com/DataONEorg/d1_libclient_java/issues) describing your planned changes, or add a comment to an existing issue;
- on GitHub, fork the [repository](https://github.com/DataONEorg/d1_libclient_java)
...
Development is managed through the git repository at https://github.com/DataONEorg/d1_libclient_java.  The repository is organized into several branches, each with a specific purpose.  
...
targeting the next release. Commits should only be pushed to this branch once they are ready to be tested and deployed to
...
3. Releases can be downloaded from the [GitHub releases page](https://github.com/DataONEorg/d1_libclient_java/releases).

## 🔬 Testing

**Unit and integration tests**. We maintain a full suite of tests in the `src/test` subdirectory.
...
clean code formatting.  We generally follow Google's Java style templates for
Java code fomatting. We generally follow PEP8 guidelines for Python code formatting,
